...
namespace MedbayTech.Pharmacies.Infrastructure.Database
{
    public class PharmacyDataSeeder
    {
        ...
        private void SeedPharmacies(PharmacyDbContext context)
        {
            ...
            context.Add(new Pharmacy { Id = "SchnabelRemote", APIKey = "ID3APIKEYAAAA", APIEndpoint = "http://schnabel.herokuapp.com/pswapi/drugs/name/", Email = "schnabel@gmail.com", RecieveNotificationFrom = true });
            context.Add(new Pharmacy { Id = "SchnabellLocal", APIKey = "ID4APIKEYAAAA", APIEndpoint = "localhost:6565", Email = "schnabel@gmail.com", RecieveNotificationFrom = true });
            context.SaveChanges();
        }
