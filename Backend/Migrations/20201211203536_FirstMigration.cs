        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Excellent = table.Column<double>(nullable: false),
                    VeryGood = table.Column<double>(nullable: false),
                    Good = table.Column<double>(nullable: false),
                    Poor = table.Column<double>(nullable: false),
                    VeryPoor = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegisteredUsers_Specializations_SpecializationId",
                        column: x => x.SpecializationId,
                        principalTable: "Specializations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorWorkDays_RegisteredUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "RegisteredUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    canceledByPatient = table.Column<bool>(nullable: false),
                    RoomId = table.Column<int>(nullable: false),
                    MedicalRecordId = table.Column<int>(nullable: false),
                    DoctorId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "policy1", "Dunav osiguranje d.o.o", new DateTime(2020, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { "policy2", "Delta generali", new DateTime(2021, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AverageGrade", "Excellent", "Good", "Poor", "Question", "QuestionType", "Status", "VeryGood", "VeryPoor" },
                values: new object[,]
                {
                    { 1, 0.0, 0.0, 0.0, 0.0, "How would you rate the kindness of your doctor?", 0, true, 0.0, 0.0 },
                    { 15, 0.0, 0.0, 0.0, 0.0, "How would you rate the organization of the hospital when scheduling an examination?", 2, true, 0.0, 0.0 },
                    { 14, 0.0, 0.0, 0.0, 0.0, "To what extent are you satisfied with the equipment of the hospital for the needs of your treatment?", 2, true, 0.0, 0.0 },
                    { 13, 0.0, 0.0, 0.0, 0.0, "How would you rate the cleanliness and comfort of the patient's room?", 2, true, 0.0, 0.0 },
                    { 12, 0.0, 0.0, 0.0, 0.0, "How would you rate the cleanliness of the toilet in the hospital?", 2, true, 0.0, 0.0 },
                    { 11, 0.0, 0.0, 0.0, 0.0, "How would you rate the cleanliness of hospital hallways and waiting rooms?", 2, true, 0.0, 0.0 },
                    { 10, 0.0, 0.0, 0.0, 0.0, "To what extent have nurses and technicians instructed you in the procedures they will perform during your treatment?", 1, true, 0.0, 0.0 },
                    { 8, 0.0, 0.0, 0.0, 0.0, "To what extent were nurses and technicians professional in treatment?", 1, true, 0.0, 0.0 },
                    { 6, 0.0, 0.0, 0.0, 0.0, "How would you rate the helpfulness and kindness of the information counter employees?", 1, true, 0.0, 0.0 },
                    { 5, 0.0, 0.0, 0.0, 0.0, "To what extent has your doctor paid attention to you and contributed to your more comfortable stay in the hospital?", 0, true, 0.0, 0.0 },
                    { 4, 0.0, 0.0, 0.0, 0.0, "How would you rate the competence of your doctor during the treatment?", 0, true, 0.0, 0.0 },
                    { 3, 0.0, 0.0, 0.0, 0.0, "How would you rate the clarity and expertise of the doctor in making the diagnosis?", 0, true, 0.0, 0.0 },
                    { 2, 0.0, 0.0, 0.0, 0.0, "To what extent has your doctor clearly stated what your examination will look like and instructed you on how to behave?", 0, true, 0.0, 0.0 },
                    { 9, 0.0, 0.0, 0.0, 0.0, "To what extent have nurses and technicians paid attention to you and your comfortable hospital stay?", 1, true, 0.0, 0.0 },
                    { 7, 0.0, 0.0, 0.0, 0.0, "How would you rate the helpfulness and kindness of nurses and technicians?", 1, true, 0.0, 0.0 }
                });
            ...
            migrationBuilder.InsertData(
                table: "RegisteredUsers",
                columns: new[] { "Id", "CurrResidenceId", "DateOfBirth", "DateOfCreation", "Discriminator", "EducationLevel", "Email", "Gender", "InsurancePolicyId", "Name", "NotificationId", "Password", "Phone", "PlaceOfBirthId", "Profession", "ProfileImage", "Surname", "Username", "Biography", "CurrentlyWorking", "VacationLeave", "WorkersID", "DepartmentId", "ExaminationRoomId", "LicenseNumber", "OnCall", "OperationRoomId", "PatientReview", "SpecializationId" },
                values: new object[,]
                {
                    { "2406978890047", 1, new DateTime(1978, 6, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Doctor", 2, "mika@gmail.com", 0, "policy1", "Milan", null, "mika1978", "065/123-4554", 11000, "vodoinstalater", ".", "Milanovic", "mika", null, false, false, 0, 1, 1, "001", true, 2, 4.5, 1 },
                    { "2407978890045", 1, new DateTime(1978, 6, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Doctor", 2, "ivan@gmail.com", 0, "policy2", "Ivan", null, "ivan123", "065/123-4554", 11000, "doctor", ".", "Ivanovic", "ivan", null, false, false, 0, 1, 1, "001", true, 2, 4.5, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2020, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "2406978890047", 15, 8 },
                    { 2, new DateTime(2020, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "2406978890047", 15, 8 },
                    { 3, new DateTime(2020, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "2406978890047", 15, 8 },
                    { 4, new DateTime(2020, 12, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "2406978890047", 15, 8 },
                    { 5, new DateTime(2020, 12, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "2406978890047", 15, 8 },
                    { 6, new DateTime(2020, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "2407978890045", 15, 8 },
                    { 7, new DateTime(2020, 12, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "2407978890045", 15, 8 },
                    { 8, new DateTime(2020, 12, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "2407978890045", 15, 8 },
                    { 9, new DateTime(2020, 12, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "2407978890045", 15, 8 },
                    { 10, new DateTime(2020, 12, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "2407978890045", 15, 8 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Appointments",
                columns: new[] { "Id", "Deleted", "DoctorId", "End", "Finished", "MedicalRecordId", "RoomId", "ShortDescription", "Start", "TypeOfAppointment", "Urgent", "WeeklyAppointmentReportId", "canceledByPatient" },
                values: new object[,]
                {
                    { 1, false, "2406978890047", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1, false },
                    { 2, false, "2406978890047", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1, false },
                    { 3, false, "2406978890047", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1, false },
                    { 4, false, "2406978890047", new DateTime(2020, 12, 5, 8, 30, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(2020, 12, 5, 8, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1, false },
                    { 5, false, "2406978890047", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1, false },
                    { 6, false, "2406978890047", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1, false }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegisteredUsers_SpecializationId",
                table: "RegisteredUsers",
                column: "SpecializationId");
