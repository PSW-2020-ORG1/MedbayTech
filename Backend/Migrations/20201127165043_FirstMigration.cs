    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, "Sljivovica za smirenje zivaca" },
                    { 6, "Krpa" },
                    { 5, "Papir" },
                    { 4, "Spric" },
                    { 3, "Sapun" },
            ...
            migrationBuilder.InsertData(
                table: "Medications",
                columns: new[] { "Id", "Company", "Med", "MedicalRecordId", "MedicationCategoryId", "MedicationId", "Quantity", "Status" },
                values: new object[,]
                {
                    { 1, "Famar", "Brufen", 0, 1, null, 10, 0 },
                    { 6, "Famar", "Grafalon", 0, 1, null, 15, 1 },
                    { 5, "Goodwill", "Sirup", 0, 1, null, 15, 1 },
                    { 4, "Famar", "Phlebodia", 0, 1, null, 15, 1 },
                    { 3, "Goodwill", "Neoangin", 0, 1, null, 15, 1 },
                    { 2, "Goodwill", "Metafex", 0, 1, null, 15, 1 },
                    { 7, "Goodwill", "Zalfija", 0, 1, null, 15, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 1, "blablal", "Medbay" },
                    { 2, 3, "Nebitno 1", "Hospital 1" },
                    { 3, 4, "Nebitno 2", "Hospital 2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 10, 3, 1, "F2-G3", 1, 1, "Soba za pregledanje" },
                    { 2, 10, 3, 2, "F1-C3", 2, 0, "Soba za pregledanje" },
                    { 3, 10, 3, 3, "F1-C5", 3, 2, "Soba za pregledanje" },
                    { 4, 10, 3, 4, "F1-R5", 4, 2, "Soba za pregledanje" },
                    { 5, 10, 3, 5, "F2-C4", 5, 3, "Soba za pregledanje" },
                    { 6, 10, 3, 6, "F1-G1", 6, 3, "Soba za pregledanje" },
                    { 7, 10, 3, 7, "F2-C2", 7, 0, "Soba za pregledanje" },
