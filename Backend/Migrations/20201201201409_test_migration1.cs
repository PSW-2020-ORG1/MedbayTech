        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 12, "Famar", "40mg", "Adderall", 0, 1, null, 15, 1112, 1 },
                    { 13, "Hemofarm", "100mg", "Hemomicin", 0, 1, null, 15, 1112, 1 },
                    { 14, "Galenika", "20mg", "Klonopin", 0, 1, null, 15, 1112, 1 },
                    { 15, "Hemofarm", "30mg", "Demerol", 0, 1, null, 15, 1112, 1 },
                    { 16, "Famar", "40mg", "OxyCotin", 0, 1, null, 15, 1112, 1 },
                    { 17, "Goodwill", "60mg", "Percocet", 0, 1, null, 15, 1112, 1 },
                    { 18, "Bosnalijek", "80mg", "Ritalin", 0, 1, null, 15, 1112, 1 },
                    { 19, "Famar", "100mg", "Eritromicin", 0, 1, null, 15, 1112, 1 },
                    { 20, "Bosnalijek", "200mg", "Penicillin", 0, 1, null, 15, 1112, 1 },
                    { 21, "Hemofarm", "150mg", "Amoksicilin", 0, 1, null, 15, 1213, 1 },
                    { 22, "Galenika", "200mg", "Cefaleksin", 0, 1, null, 15, 1213, 1 },
                    { 23, "Goodwill", "500mg", "Zoloft", 0, 1, null, 15, 1213, 1 },
                    { 24, "Famar", "40mg", "Lexilium", 0, 1, null, 15, 1213, 1 },
                    { 25, "Hemofarm", "50mg", "Bensedin", 0, 1, null, 15, 1213, 1 },
                    { 26, "Hemofarm", "50mg", "Benedril", 0, 1, null, 15, 1213, 1 },
                    { 27, "Galenika", "100mg", "Letrox", 0, 1, null, 15, 1213, 1 },
                    { 28, "Famar", "25mg", "Claritin", 0, 1, null, 15, 1213, 1 },
                    { 29, "Hemofarm", "500mg", "Flobian", 0, 1, null, 15, 1213, 1 },
                    { 30, "Galenika", "75mg", "Lasix", 0, 1, null, 15, 1213, 1 },
                    ...
                    { 11, "Hemofarm", "50mg", "Vicodin", 0, 1, null, 15, 1112, 1 },
                    { 63, "Goodwill", "500mg", "Zoloft", 0, 1, null, 15, 2106, 1 },
                    { 10, "Galenika", "200mg", "Ranisan", 0, 1, null, 15, 1111, 1 },
                    { 8, "Galenika", "50mg", "Plavix", 0, 1, null, 15, 1111, 1 },
                    ...
                    { 1, "Famar", "400mg", "Brufen", 0, 1, null, 10, 1111, 0 },
                    { 2, "Goodwill", "20mg", "Xanax", 0, 1, null, 15, 1111, 1 },
                    { 3, "Hemofarm", "500mg", "Panadon", 0, 1, null, 15, 1111, 1 },
                    { 4, "Famar", "30mg", "Diazepam", 0, 1, null, 15, 1111, 1 },
                    { 5, "Goodwill", "200mg", "Andol", 0, 1, null, 15, 1111, 1 },
                    { 6, "Famar", "100mg", "Reglan", 0, 1, null, 15, 1111, 1 },
                    { 7, "Bosnalijek", "400mg", "Caffetin", 0, 1, null, 15, 1111, 1 },
                    { 9, "Famar", "25mg", "Ambien", 0, 1, null, 15, 1111, 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "2406978890047", "Interna medicina" },
                    { 2, "2406978890047", "Hirurgija" }
                });
