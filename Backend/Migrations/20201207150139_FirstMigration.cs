...
namespace Backend.Migrations
{
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Appointments",
                columns: new[] { "Id", "CanceledByPatient", "Deleted", "DoctorId", "End", "Finished", "MedicalRecordId", "RoomId", "ShortDescription", "Start", "TypeOfAppointment", "Urgent", "WeeklyAppointmentReportId" },
                values: new object[,]
                {
                    { 1, false, false, "2406978890047", new DateTime(2020, 12, 5, 14, 30, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(2020, 12, 5, 14, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1 },
                    { 2, false, false, "2406978890047", new DateTime(2020, 12, 4, 14, 30, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(2020, 12, 4, 14, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1 },
                    { 3, false, false, "2406978890047", new DateTime(2020, 12, 3, 14, 30, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(2020, 12, 3, 14, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1 },
                    { 4, false, false, "2406978890047", new DateTime(2020, 12, 1, 14, 30, 0, 0, DateTimeKind.Unspecified), true, 1, 1, "standard appointment", new DateTime(2020, 12, 1, 14, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1 },
                    { 5, false, false, "2406978890047", new DateTime(2020, 12, 15, 14, 30, 0, 0, DateTimeKind.Unspecified), false, 1, 1, "standard appointment", new DateTime(2020, 12, 15, 14, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1 },
                    { 6, false, false, "2406978890047", new DateTime(2020, 12, 8, 14, 30, 0, 0, DateTimeKind.Unspecified), false, 1, 1, "standard appointment", new DateTime(2020, 12, 8, 14, 0, 0, 0, DateTimeKind.Unspecified), 0, true, 1 }
                });
