    ...
    public class MySqlContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Diagnosis>().HasData(
                new Diagnosis { Id = 1, Name = "Dijagnoza1", Symptoms = new List<Symptoms>(), MedicalRecordId = 1, ExaminationSurgeryId = 3 },
                new Diagnosis { Id = 2, Name = "Dijagnoza2", Symptoms = new List<Symptoms>(), MedicalRecordId = 1, ExaminationSurgeryId = 3}
            );
            ...
            modelBuilder.Entity<Treatment>().HasData(
                ...
                {
                    Id = 1,
                    AdditionalNotes = "vauuuu",
                    Date = new DateTime(),
                    ExaminationSurgeryId = 3,
                    Type = TreatmentType.HospitalTreatment
                }
            );
