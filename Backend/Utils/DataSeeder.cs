...
namespace Backend.Utils
{
    public class DataSeeder
    {
        ...
        {
            context.Add(new Medication { Med = "Brufen", Dosage = "400mg", RoomId = 1, Status = MedStatus.Approved, Company = "Famar", Quantity = 10, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Xanax", Dosage = "20mg", RoomId = 1, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Panadon", Dosage = "500mg", RoomId = 1, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Diazepam", Dosage = "30mg", RoomId = 1, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Andol", Dosage = "200mg", RoomId = 1, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Reglan", Dosage = "100mg", RoomId = 2, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Caffetin", Dosage = "400mg", RoomId = 2, Status = MedStatus.Validation, Company = "Bosnalijek", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Plavix", Dosage = "50mg", RoomId = 2, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Ambien", Dosage = "25mg", RoomId = 2, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Ranisan", Dosage = "200mg", RoomId = 2, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Vicodin", Dosage = "50mg", RoomId = 2, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Adderall", Dosage = "40mg", RoomId = 2, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Hemomicin", Dosage = "100mg", RoomId = 2, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Klonopin", Dosage = "20mg", RoomId = 3, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Demerol", Dosage = "30mg", RoomId = 3, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "OxyCotin", Dosage = "40mg", RoomId = 3, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Percocet", Dosage = "60mg", RoomId = 3, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Ritalin", Dosage = "80mg", RoomId = 3, Status = MedStatus.Validation, Company = "Bosnalijek", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Eritromicin", Dosage = "100mg", RoomId = 3, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Penicillin", Dosage = "200mg", RoomId = 3, Status = MedStatus.Validation, Company = "Bosnalijek", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Amoksicilin", Dosage = "150mg", RoomId = 3, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Cefaleksin", Dosage = "200mg", RoomId = 4, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Zoloft", Dosage = "500mg", RoomId = 4, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Lexilium", Dosage = "40mg", RoomId = 4, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Bensedin", Dosage = "50mg", RoomId = 4, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Benedril", Dosage = "50mg", RoomId = 4, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Letrox", Dosage = "100mg", RoomId = 4, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Claritin", Dosage = "25mg", RoomId = 4, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Flobian", Dosage = "500mg", RoomId = 4, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Lasix", Dosage = "75mg", RoomId = 4, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Brufen", Dosage = "200mg", RoomId = 4, Status = MedStatus.Approved, Company = "Famar", Quantity = 10, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Xanax", Dosage = "40mg", RoomId = 4, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Panadon", Dosage = "200mg", RoomId = 4, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            ...
            context.Add(new Medication { Med = "Demerol", Dosage = "30mg", RoomId = 6, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Brufen", Dosage = "400mg", RoomId = 6, Status = MedStatus.Approved, Company = "Famar", Quantity = 10, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Xanax", Dosage = "20mg", RoomId = 6, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Panadon", Dosage = "500mg", RoomId = 6, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Diazepam", Dosage = "30mg", RoomId = 6, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Andol", Dosage = "200mg", RoomId = 6, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Reglan", Dosage = "100mg", RoomId = 6, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Caffetin", Dosage = "400mg", RoomId = 7, Status = MedStatus.Validation, Company = "Bosnalijek", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Plavix", Dosage = "50mg", RoomId = 7, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Ambien", Dosage = "25mg", RoomId = 7, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Ranisan", Dosage = "200mg", RoomId = 7, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Vicodin", Dosage = "50mg", RoomId = 7, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Adderall", Dosage = "40mg", RoomId = 7, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Hemomicin", Dosage = "100mg", RoomId = 7, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Klonopin", Dosage = "20mg", RoomId = 7, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Demerol", Dosage = "30mg", RoomId = 7, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "OxyCotin", Dosage = "40mg", RoomId = 7, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Percocet", Dosage = "60mg", RoomId = 7, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Ritalin", Dosage = "80mg", RoomId = 7, Status = MedStatus.Validation, Company = "Bosnalijek", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Eritromicin", Dosage = "100mg", RoomId = 7, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Penicillin", Dosage = "200mg", RoomId = 7, Status = MedStatus.Validation, Company = "Bosnalijek", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Amoksicilin", Dosage = "150mg", RoomId = 8, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Cefaleksin", Dosage = "200mg", RoomId = 8, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Zoloft", Dosage = "500mg", RoomId = 8, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Lexilium", Dosage = "40mg", RoomId = 8, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Bensedin", Dosage = "50mg", RoomId = 8, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Letrox", Dosage = "100mg", RoomId = 8, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Claritin", Dosage = "25mg", RoomId = 8, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Flobian", Dosage = "500mg", RoomId = 8, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Lasix", Dosage = "75mg", RoomId = 8, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Brufen", Dosage = "200mg", RoomId = 8, Status = MedStatus.Approved, Company = "Famar", Quantity = 10, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Xanax", Dosage = "40mg", RoomId = 8, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Panadon", Dosage = "200mg", RoomId = 8, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Diazepam", Dosage = "60mg", RoomId = 8, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Andol", Dosage = "400mg", RoomId = 8, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Vicodin", Dosage = "50mg", RoomId = 7, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Adderall", Dosage = "80mg", RoomId = 8, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Hemomicin", Dosage = "100mg", RoomId = 8, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Klonopin", Dosage = "20mg", RoomId = 8, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            ...
            context.Add(new Medication { Med = "Amoksicilin", Dosage = "250mg", RoomId = 9, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Cefaleksin", Dosage = "100mg", RoomId = 9, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Zoloft", Dosage = "200mg", RoomId = 9, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Lexilium", Dosage = "80mg", RoomId = 9, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Bensedin", Dosage = "10mg", RoomId = 9, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Brufen", Dosage = "100mg", RoomId = 9, Status = MedStatus.Approved, Company = "Famar", Quantity = 10, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Xanax", Dosage = "60mg", RoomId = 9, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Panadon", Dosage = "250mg", RoomId = 9, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Diazepam", Dosage = "800mg", RoomId = 9, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Andol", Dosage = "150mg", RoomId = 9, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Reglan", Dosage = "125mg", RoomId = 9, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Caffetin", Dosage = "200mg", RoomId = 9, Status = MedStatus.Validation, Company = "Bosnalijek", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Plavix", Dosage = "100mg", RoomId = 9, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Ambien", Dosage = "50mg", RoomId = 9, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Ranisan", Dosage = "100mg", RoomId = 9, Status = MedStatus.Validation, Company = "Galenika", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Demerol", Dosage = "60mg", RoomId = 9, Status = MedStatus.Validation, Company = "Hemofarm", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "OxyCotin", Dosage = "25mg", RoomId = 9, Status = MedStatus.Validation, Company = "Famar", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Percocet", Dosage = "30mg", RoomId = 9, Status = MedStatus.Validation, Company = "Goodwill", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            context.Add(new Medication { Med = "Ritalin", Dosage = "40mg", RoomId = 9, Status = MedStatus.Validation, Company = "Bosnalijek", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
            ...
            context.Add(new Medication { Med = "Penicillin", Dosage = "100mg", RoomId = 9, Status = MedStatus.Validation, Company = "Bosnalijek", Quantity = 15, MedicationContent = new List<DosageOfIngredient>(), MedicationCategoryId = 1, Allergens = new List<Allergens>(), AlternativeMedication = new List<Medication>(), SideEffects = new List<SideEffect>() });
        ...
        {
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 8, RoomId = 1003, EquipmentTypeId = 9 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 8, RoomId = 1003, EquipmentTypeId = 10 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 1003, EquipmentTypeId = 17 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 1003, EquipmentTypeId = 18 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 1003, EquipmentTypeId = 19 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 9, RoomId = 1003, EquipmentTypeId = 22 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 11, RoomId = 1003, EquipmentTypeId = 23 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 1003, EquipmentTypeId = 24 });
            context.Add(new HospitalEquipment { QuantityInRoom = 50, QuantityInStorage = 200, RoomId = 1003, EquipmentTypeId = 25 });
            context.Add(new HospitalEquipment { QuantityInRoom = 70, QuantityInStorage = 250, RoomId = 1003, EquipmentTypeId = 26 });
            context.Add(new HospitalEquipment { QuantityInRoom = 90, QuantityInStorage = 300, RoomId = 1003, EquipmentTypeId = 27 });
            context.Add(new HospitalEquipment { QuantityInRoom = 100, QuantityInStorage = 500, RoomId = 1003, EquipmentTypeId = 28 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 6, RoomId = 1003, EquipmentTypeId = 29 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 12, RoomId = 1003, EquipmentTypeId = 30 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 13, RoomId = 1003, EquipmentTypeId = 31 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 14, RoomId = 1003, EquipmentTypeId = 32 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 10, RoomId = 1003, EquipmentTypeId = 34 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 20, RoomId = 1003, EquipmentTypeId = 35 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 1003, EquipmentTypeId = 36 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 1003, EquipmentTypeId = 37 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 1012, EquipmentTypeId = 6 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 16, RoomId = 1012, EquipmentTypeId = 7 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 1014, EquipmentTypeId = 8 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 1014, EquipmentTypeId = 9 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 1014, EquipmentTypeId = 10 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 1014, EquipmentTypeId = 11 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 1014, EquipmentTypeId = 12 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 15, RoomId = 1014, EquipmentTypeId = 33 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 10, RoomId = 1014, EquipmentTypeId = 34 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 20, RoomId = 1014, EquipmentTypeId = 35 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 4, RoomId = 1019, EquipmentTypeId = 5 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 1019, EquipmentTypeId = 6 });

            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 0, RoomId = 1110, EquipmentTypeId = 3 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 1, RoomId = 1113, EquipmentTypeId = 1 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 0, RoomId = 1114, EquipmentTypeId = 2 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 1, RoomId = 1115, EquipmentTypeId = 1 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 0, RoomId = 1116, EquipmentTypeId = 3 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 0, RoomId = 1119, EquipmentTypeId = 4 });

            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 10, RoomId = 1210, EquipmentTypeId = 34 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 20, RoomId = 1210, EquipmentTypeId = 35 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 5, RoomId = 1210, EquipmentTypeId = 36 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 8, RoomId = 1217, EquipmentTypeId = 8 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 1217, EquipmentTypeId = 11 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 1217, EquipmentTypeId = 12 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 1217, EquipmentTypeId = 13 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 1217, EquipmentTypeId = 18 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 1217, EquipmentTypeId = 19 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 30, RoomId = 1217, EquipmentTypeId = 20 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 30, RoomId = 1217, EquipmentTypeId = 21 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 9, RoomId = 1217, EquipmentTypeId = 22 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 11, RoomId = 1217, EquipmentTypeId = 23 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 1217, EquipmentTypeId = 24 });
            context.Add(new HospitalEquipment { QuantityInRoom = 50, QuantityInStorage = 200, RoomId = 1217, EquipmentTypeId = 25 });
            context.Add(new HospitalEquipment { QuantityInRoom = 70, QuantityInStorage = 250, RoomId = 1217, EquipmentTypeId = 26 });
            context.Add(new HospitalEquipment { QuantityInRoom = 90, QuantityInStorage = 300, RoomId = 1217, EquipmentTypeId = 27 });
            context.Add(new HospitalEquipment { QuantityInRoom = 100, QuantityInStorage = 500, RoomId = 1217, EquipmentTypeId = 28 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 6, RoomId = 1217, EquipmentTypeId = 29 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 12, RoomId = 1217, EquipmentTypeId = 30 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 13, RoomId = 1217, EquipmentTypeId = 31 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 14, RoomId = 1217, EquipmentTypeId = 32 });

            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 8, RoomId = 2005, EquipmentTypeId = 9 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 8, RoomId = 2005, EquipmentTypeId = 10 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 2005, EquipmentTypeId = 17 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 2005, EquipmentTypeId = 18 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 2005, EquipmentTypeId = 19 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 9, RoomId = 2005, EquipmentTypeId = 22 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 11, RoomId = 2005, EquipmentTypeId = 23 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 2005, EquipmentTypeId = 24 });
            context.Add(new HospitalEquipment { QuantityInRoom = 50, QuantityInStorage = 200, RoomId = 2005, EquipmentTypeId = 25 });
            context.Add(new HospitalEquipment { QuantityInRoom = 70, QuantityInStorage = 250, RoomId = 2005, EquipmentTypeId = 26 });
            context.Add(new HospitalEquipment { QuantityInRoom = 90, QuantityInStorage = 300, RoomId = 2005, EquipmentTypeId = 27 });
            context.Add(new HospitalEquipment { QuantityInRoom = 100, QuantityInStorage = 500, RoomId = 2005, EquipmentTypeId = 28 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 6, RoomId = 2005, EquipmentTypeId = 29 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 12, RoomId = 2005, EquipmentTypeId = 30 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 13, RoomId = 2005, EquipmentTypeId = 31 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 14, RoomId = 2005, EquipmentTypeId = 32 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 10, RoomId = 2005, EquipmentTypeId = 34 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 20, RoomId = 2005, EquipmentTypeId = 35 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 2005, EquipmentTypeId = 36 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 2005, EquipmentTypeId = 37 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 2009, EquipmentTypeId = 8 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 2009, EquipmentTypeId = 9 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 2009, EquipmentTypeId = 10 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 2009, EquipmentTypeId = 11 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 2009, EquipmentTypeId = 12 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 15, RoomId = 2009, EquipmentTypeId = 33 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 10, RoomId = 2009, EquipmentTypeId = 34 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 20, RoomId = 2009, EquipmentTypeId = 35 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 40, RoomId = 2009, EquipmentTypeId = 39 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 2010, EquipmentTypeId = 40 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 2013, EquipmentTypeId = 40 });

            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 2105, EquipmentTypeId = 14 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 6, RoomId = 2108, EquipmentTypeId = 15 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 7, RoomId = 2117, EquipmentTypeId = 16 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 7, RoomId = 2118, EquipmentTypeId = 16 });

            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 10, RoomId = 2208, EquipmentTypeId = 34 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 20, RoomId = 2208, EquipmentTypeId = 35 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 5, RoomId = 2208, EquipmentTypeId = 36 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 10, RoomId = 2209, EquipmentTypeId = 34 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 20, RoomId = 2209, EquipmentTypeId = 35 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 5, RoomId = 2209, EquipmentTypeId = 36 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 2210, EquipmentTypeId = 17 });
            context.Add(new HospitalEquipment { QuantityInRoom = 20, QuantityInStorage = 100, RoomId = 2210, EquipmentTypeId = 24 });

            context.Add(new HospitalEquipment { QuantityInRoom = 50, QuantityInStorage = 200, RoomId = 2210, EquipmentTypeId = 25 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 10, RoomId = 2210, EquipmentTypeId = 34 });
            context.Add(new HospitalEquipment { QuantityInRoom = 3, QuantityInStorage = 20, RoomId = 2210, EquipmentTypeId = 35 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 2210, EquipmentTypeId = 36 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 5, RoomId = 2210, EquipmentTypeId = 37 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 2217, EquipmentTypeId = 8 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 2217, EquipmentTypeId = 9 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 8, RoomId = 2217, EquipmentTypeId = 10 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 2217, EquipmentTypeId = 11 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 2217, EquipmentTypeId = 12 });
            context.Add(new HospitalEquipment { QuantityInRoom = 1, QuantityInStorage = 2, RoomId = 2217, EquipmentTypeId = 13 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 15, RoomId = 2217, EquipmentTypeId = 33 });
            context.Add(new HospitalEquipment { QuantityInRoom = 2, QuantityInStorage = 10, RoomId = 2217, EquipmentTypeId = 34 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 20, RoomId = 2217, EquipmentTypeId = 35 });
            context.Add(new HospitalEquipment { QuantityInRoom = 4, QuantityInStorage = 40, RoomId = 2217, EquipmentTypeId = 39 });
            context.SaveChanges();
        }
