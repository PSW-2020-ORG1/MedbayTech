...
namespace SimsProjekat
{
    ...
    {
        private const string MEDICATION_FILE = "../../../Data/medications.json";
        private const string VALIDATION_FILE = "../../../Data/validations.json";
        private const string ALLERGEN_FILE = "../../../Data/allergens.json";
        private const string CATEGORY_FILE = "../../../Data/medicationcategories.json";
        private const string SYMPTOMS_FILE = "../../../Data/symptoms.json";
        private const string INGREDIENTS_FILE = "../../../Data/medicationingredients.json";
        private const string SPECIALIZATION_FILE = "../../../Data/specializations.json";
        private const string USER_FILE = "../../../Data/users.json";
        private const string CITY_FILE = "../../../Data/cities.json";
        private const string ADDRESS_FILE = "../../../Data/addresses.json";
        private const string STATE_FILE = "../../../Data/states.json";
        private const string INSURANCE_FILE = "../../../Data/insurances.json";
        private const string DEPARTMENT_FILE = "../../../Data/departments.json";
        private const string ROOM_FILE = "../../../Data/rooms.json";
        private const string RENOVATION_FILE = "../../../Data/renovations.json";
        private const string BED_FILE = "../../../Data/beds.json";
        private const string HOSPITAL_FILE = "../../../Data/hospitals.json";
        private const string EQUIPMENT_TYPE_FILE = "../../../Data/equipmenttype.json";
        private const string EQUIPMENT_FILE = "../../../Data/equipments.json";
        private const string RECORD_FILE = "../../../Data/records.json";
        private const string DIAGNOSIS_FILE = "../../../Data/diagnosis.json";
        private const string TREATMENTS_FILE = "../../../Data/treatments.json";
        private const string EXAMINATION_SURGERY_FILE = "../../../Data/examinations.json";
        private const string EMERGENCY_REQUEST_FILE = "../../../Data/requests.json";
        private const string VACCINES_FILE = "../../../Data/vaccines.json";
        private const string ARTICLE_FILE = "../../../Data/articles.json";
        private const string NOTIFICATION_FILE = "../../../Data/notifications.json";
        private const string QUESTIONS_FILE = "../../../Data/questions.json";
        private const string DOCTOR_REVIEWS_FILE = "../../../Data/doctorreviews.json";
        private const string FEEDBACK_FILE = "../../../Data/feedbacks.json";
        private const string SURVEY_FILE = "../../../Data/surveys.json";
        private const string APPOINTMENTS_FILE = "../../../Data/appointments.json";
        private const string WORK_DAY_FILE = "../../../Data/workdays.json";
        private const string VACATION_REQUEST_FILE = "../../../Data/vacationrequests.json";
        private const string REPORTS_FILE = "../../../Data/reports.json";
        private const string LAB_TEST_TYPE_FILE = "../../../Data/labtypes.json";
        ...
        public Application()
        {
            ...
            //var suMicrosoft.EntityFrameworkCore.ProxiesrveyService = new SurveyService(surveyRepository);
