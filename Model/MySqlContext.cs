    ...
    public class MySqlContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Feedback>().HasData(
                ...
                new Feedback { Id = 2, AdditionalNotes = "Bolnica je veoma losa, bas sam razocaran! Rupe u zidovima, voda curi na sve strane, treba vas zatvoriti!!!", Approved = true, Date = new DateTime(), RegisteredUserId = "2406978890045", Anonymous = false },
                new Feedback { Id = 3, AdditionalNotes = "Predivno, ali i ruzno! Sramite se! Cestitke... <3", Approved = true, Date = new DateTime(), RegisteredUserId = "2406978890045", Anonymous = false },
                new Feedback { Id = 4, AdditionalNotes = "Odlicno!", Approved = true, Date = new DateTime(), RegisteredUserId = "2406978890045", Anonymous = true }
            );
